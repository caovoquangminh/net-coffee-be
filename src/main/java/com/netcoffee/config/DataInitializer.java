...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            log.error("seedMenu failed: {}", e.getMessage());
        }
        try {
            seedMachines();
        } catch (Exception e) {
            log.error("seedMachines failed: {}", e.getMessage());
        }
        try {
            removeLegacyItems();
        } catch (Exception e) {
            log.error("removeLegacyItems failed: {}", e.getMessage());
        }
    }
    ...
    private void seedMenu() {
        ...
        List<TMenuItemEntity> miItems =
                List.of(miGoi, miTrung, miXucXich, miBo, miTom, miXao, comChienTrung, comBoXao);
